...
Five ready-to-use CSV datasets you can copy and use to test Tableau Stimulator
...
4. Upload to Tableau Stimulator via the upload zone in the left pane
...
4. **No merged cells** — Tableau Stimulator reads flat tabular data only
