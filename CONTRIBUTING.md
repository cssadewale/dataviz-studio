# Contributing to Tableau Stimulator
...
Tableau Stimulator has **no build step, no package manager, and no dependencies to install**.
...
Thank you for contributing to Tableau Stimulator.
