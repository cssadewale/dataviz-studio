...
## Tableau Stimulator Enhancement Release — 2026-05-22

- Renamed platform from DataViz Studio to **Tableau Stimulator**.
- Embedded creator details for Adewale Samson Adeagbo in the platform About modal, README, deployment guide and system guide.
- Added Tableau-style menu strip: File, Data, Worksheet, Dashboard, Story, Show Me, Ask Data, Explain Data, Analytics, Save Workbook and Help.
- Added local **Ask Data** rule-based natural-language query tool. No AI API is used.
- Preserved all previous worksheet, dashboard, pivot, statistics, report, cleaner and export features.
- Kept the project free, static and deployable on GitHub Pages, Netlify, Vercel or direct browser use.

# Changelog

All notable changes to Tableau Stimulator are documented in this file.
